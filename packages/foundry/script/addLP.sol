...
import {IUniswapV4Router04} from "@uniswap/v4-periphery/src/interfaces/IUniswapV4Router04.sol";
...
contract AddLiquidityScript is ScaffoldETHDeploy  {
    ...
    function run() external {
        ...
        IPositionManager positionManager = IPositionManager(payable(AddressConstants.getPositionManagerAddress(block.chainid)));
